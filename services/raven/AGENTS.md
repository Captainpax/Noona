...
Raven is Noona's downloader, scraper, and library sync service.

## Hard Rules

- Keep [readme.md](readme.md) focused on how Raven fits into Noona.
- If download storage, naming, manifests, queue behavior, download limits, or admin-facing repair flows change, update
  admin docs in the same change.
